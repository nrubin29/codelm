...
export class LeaderboardCellComponent {
  ...
  isComplete() {
    return this.element.problems[this.problem._id].status === SubmissionOverviewStatus.Complete;
  }

  isError() {
    return this.element.problems[this.problem._id].status === SubmissionOverviewStatus.Error;
  }

  isIncomplete() {
    return this.element.problems[this.problem._id].status === SubmissionOverviewStatus.None &&
