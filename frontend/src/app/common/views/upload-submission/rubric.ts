...
export const rubric: RubricItem[] = [
  {
    category: 'Function',
    0:
      'A program solution is submitted but fails to compile. \n' +
      '– or –\n' +
  ...
  },
  {
    ...
    0:
      'Code contains no documentation.\n' +
      '•\n' +
    ...
    1:
      'The submitted solution is inconsistently documented.\n' +
      '•\n' +
    ...
    2:
      'The submitted solution is well documented.\n' +
      '•\n' +
  ...
  },
  {
    ...
    1:
      'Your algorithm plays the game based on the feedback from the last guess.\n' +
      '•\n' +
      'Your algorithm shows some thought and design.\n',
    2:
      'Your algorithm plays the game based on the feedback from several past guesses.\n' +
      '•\n' +
