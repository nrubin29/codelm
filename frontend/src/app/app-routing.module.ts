...
const routes: Routes = [
  ...
  {path: 'login', component: LoginComponent, canActivate: [IsNotEndGuard], resolve: {settings: SettingsResolve}},
  {path: 'register', component: RegisterComponent, canActivate: [IsNotEndGuard, OpenRegistrationGuard], resolve: {divisions: DivisionsResolve}},
  {path: 'disconnected', component: DisconnectedComponent, canActivate: [DisconnectGuard, IsNotEndGuard]},
  {path: 'end', component: EndComponent, canActivate: [IsEndGuard], resolve: {settings: SettingsResolve}},
];
